	...
	return (
		...
		>
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" width="600px">
				...
				<g id="freepik--Planets--inject-14">
					<g style={{ opacity: '0.30000000000000004' }}>
						<path
							...
							style={{ fill: '#473EBE' }}
						/>
						<circle cx="72.97" cy="216.13" r="1.32" style={{ fill: '#473EBE' }} />
						<circle cx="291.05" cy="408.33" r="1.89" style={{ fill: '#473EBE' }} />
						<circle cx="336.5" cy="332" r="1.32" style={{ fill: '#473EBE' }} />
						<path
						...
						<path
							...
							style={{ fill: '#473EBE' }}
						/>
						<circle cx="277.7" cy="136.94" r="1.32" style={{ fill: '#473EBE' }} />
					</g>
					<circle cx="141.23" cy="116.36" r="21.91" style={{ fill: '#473EBE' }} />
				...
				<g id="freepik--Astronaut--inject-14">
					...
					<path
						...
						style={{ fill: '#473EBE;opacity:0.30000000000000004' }}
					/>
					<path
					...
					<path
						...
						style={{ fill: '#473EBE;opacity:0.6000000000000001' }}
					/>
					<path
				...
				<g id="freepik--Rocket--inject-14">
					...
					<circle cx="222.2" cy="282.18" r="8.29" style={{ fill: '#473EBE' }} />
					<polygon
			...
			<div style={{ textAlign: 'center' }}>
				<h1 style={{ color: '#473EBE' }}>OOOPS!!!</h1>
				<h1 style={{ color: '#473EBE' }}>PAGE NOT FOUND</h1>
				<NavLink to="/">
					<button
						style={{
							color: '#473EBE',
